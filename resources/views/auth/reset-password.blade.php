...
<head>
    ...
    <title>Reset Password | SaaS POS</title>
    <script>
...
<body class="bg-paper dark:bg-ink text-ink dark:text-paper min-h-screen flex items-center justify-center p-4 transition-colors duration-300">
    ...
    <div class="w-full max-w-md animate-fadeInUp">
        <div class="text-center mb-6">
            ...
            <h1 class="font-display font-700 text-2xl tracking-tight">Reset your password</h1>
            <p class="text-sm mt-2 text-ink/55 dark:text-paper/55">Choose a new, strong password for your account.</p>
        </div>
        ...
        <div class="bg-white dark:bg-paper/[0.04] border border-ink/10 dark:border-paper/10 shadow-xl shadow-ink/5 rounded-2xl p-8">
            ...
            <form action="{{ route('password.update') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-mono font-semibold text-ink/50 dark:text-paper/50 uppercase tracking-wider mb-2">New Password</label>
                ...
                <div>
                    <label class="block text-xs font-mono font-semibold text-ink/50 dark:text-paper/50 uppercase tracking-wider mb-2">Confirm New Password</label>
